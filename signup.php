<?php
    ...
    session_start();
    define('TITLE',"Signup | StudentConnect");
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 offset-sm-1">
                        ...
                        <div class="signup-left position-fixed text-center">
                            ...
                            <form id="signup-form" action="includes/signup.inc.php" method='post' 
                                ...
                                <input type="submit" class="btn btn-dark btn-lg" name="signup-submit" value="Signup">
                    ...
                    <div class="col-sm-6 offset-sm-6 text-center">
                        ...
                        <h1 class="Letsgo">Signup and Lets Go!</h1>
                        <br><br><br>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 align-self-center">
                                ...
                                <br><br><label class="btn btn-dark ">
