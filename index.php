...
<?php
    ...
    define('TITLE',"Dashboard| StudentConnect");
...
?> 
    ...
    <body onload="pageLoad()">
        ...
        <img class="imgLogo"src='img/flogo2.jpg' id='loader-logo'>
            <div class="loader">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7" >
                        ...
                        <div class="text-center p-3">
                            <img class="imgLogo" src="img/flogo2.jpg">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="forum" role="tabpanel" aria-labelledby="forum-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="imgLogo" src="img/flogo2.jpg" alt="" width="48" height="48">
                                  <div class="lh-100">
                                    <h1 id="Heading" class="mb-0 text-white lh-100">Latest Forums</h1>
                                  </div>
                                </div>  
                                            ...
                                            while ($row = mysqli_fetch_assoc($result))
                                            {
                                                echo '<div class="col-md-6">
                                                        ...
                                                        <img class="card-img-left flex-auto d-none d-lg-block blogindex-cover" 
                                                                src="img/forum-coverF.jpg" alt="Card image cap">
                                                                </a>
                            ...
                            <div class="tab-pane fade" id="blog" role="blog" aria-labelledby="blog-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="imgLogo" src="img/flogo2.jpg" alt="" width="48" height="48">
                                  <div class="lh-100">
                                    <h1 id="Heading" class="mb-0 text-white lh-100">Latest Blogs</h1>
                                  </div>
                                </div>  
                            ...
                            <div class="tab-pane fade" id="poll" role="poll" aria-labelledby="poll-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="imgLogo" src="img/flogo2.jpg" alt="" width="48" height="48">
                                  <div class="lh-100">
                                    <h1 id="Heading" class="mb-0 text-white lh-100">Latest Polls</h1>
                                  </div>
                                </div>  
                                        ...
                                        while ($row = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            echo '<a href="poll.php?poll='.$row['id'].'">
                                                <div class="media text-muted pt-3">
                                                    <img src="img/poll2.png" alt="" class="mr-2 rounded div-img poll-img">
                    ...
                    <div class="col-sm-2">
                        ...
                        <a href="forum.php" class="btn btn-warning btn-lg btn-block">Forum</a>
                        <a href="hub.php" class="btn btn-secondary btn-lg btn-block">Hub</a>
                        <br><br><br>
