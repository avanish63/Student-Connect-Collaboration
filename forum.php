<?php
    ...
    define('TITLE',"Forum | StudentConnect");
...
?>  
    ...
    <body style="background: #333333">
      ...
      <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
          <img class="mr-3" src="img/flogo2.jpg" alt="" width="48" height="48">
        <div class="lh-100">
          <h1 class="Forums">Forums</h1>
          <small>Connecting Students, Shaping Communit</small>
        </div>
      </div>
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                    ...
                    echo '<a href="topics.php?cat='.$row['cat_id'].'">
                        <div class="media text-muted pt-3">
                            <img src="img/BnG2.png" alt="" class="mr-2 rounded div-img ">
